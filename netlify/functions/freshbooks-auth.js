...
const SCOPES       = 'user:profile:read user:expenses:read user:expenses:write user:bills:read user:bills:write user:bill_vendors:read user:bill_vendors:write user:teams:read';
